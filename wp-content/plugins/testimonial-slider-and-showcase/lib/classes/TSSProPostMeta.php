...
if (!class_exists('TSSProPostMeta')):
    ...
    class TSSProPostMeta
    {
	    ...
	    function tss_after_title($post){
		    ...
		    $html .= '<p style="text-align: center;"><a style="color: red; text-decoration: none; font-size: 14px;" href="https://www.radiustheme.com/wordpress/wordpress-plugins/" target="_blank">Pro version coming soon ...</a></p>';
		    $html .= '</div></div>';
        ...
        function add_testimonial_meta_box() {
            add_meta_box('tss_meta_information', __('Testimonial\'s Information', 'tlp-portfolio-pro'), array($this, 'tss_meta_information'), TSSPro()->post_type, 'normal', 'high');
        }

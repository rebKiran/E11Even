...
<div id="testimonials" class="full homeSection clearfix <?php if($testimonails_bkg) echo "hasBackground"; ?>">
	...
	?>
	<div class="wrap homeSection">
<div class="posts clearfix">
	 <img src="<?php echo site_url();?>/wp-content/uploads/2017/03/stars.png" alt="Stars"  width="100"> 

<?php echo do_shortcode( '[rt-testimonial id="327" title="slider1"]' ) ?>
